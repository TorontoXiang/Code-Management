...
public:
	...
	{
		_density=density;_internal_energy=_soundspeed=_pressure=0;_EOS=NULL;
	}
	
	TMAT_base(double density,double internal_energy,TEOS_base* EOS)    //Constructor for fluid material
	{
		_density=density;_internal_energy=internal_energy;_EOS=EOS;
	}
